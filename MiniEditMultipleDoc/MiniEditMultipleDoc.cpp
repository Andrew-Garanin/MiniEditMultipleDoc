...
// MiniEditMultipleDoc.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMiniEditMultipleDocApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMiniEditMultipleDocApp::OnAppAbout)
...
// Создание CMiniEditMultipleDocApp

CMiniEditMultipleDocApp::CMiniEditMultipleDocApp() noexcept
{
	...
	SetAppID(_T("MiniEditMultipleDoc.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMiniEditMultipleDocApp

CMiniEditMultipleDocApp theApp;


// Инициализация CMiniEditMultipleDocApp

BOOL CMiniEditMultipleDocApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MiniEditMultipleDocTYPE,
		RUNTIME_CLASS(CMiniEditMultipleDocDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CMiniEditMultipleDocView));
	if (!pDocTemplate)
		return FALSE;
...
int CMiniEditMultipleDocApp::ExitInstance()
{
	//TODO: обработайте дополнительные ресурсы, которые могли быть добавлены
	return CWinApp::ExitInstance();
}

// Обработчики сообщений CMiniEditMultipleDocApp
...
void CMiniEditMultipleDocApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
